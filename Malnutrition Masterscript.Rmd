...
#Averaging
################################################################################
AVG_FS_RLF_Stunting = data.frame(Importance = double())
...
for (factor in names(stunting)[1:54]){
  ...
  AVG_FS_RLF_Stunting[[factor, 1]] = sum/100
}
write.csv(AVG_FS_RLF_Stunting, "AVG_FS_RLF_Stunting.csv")
################################################################################
AVG_FS_RLF_Thinness = data.frame(Importance = double())
...
for (factor in names(thinness)[1:54]){
  ...
  AVG_FS_RLF_Thinness[[factor, 1]] = sum/100
}
write.csv(AVG_FS_RLF_Thinness, "AVG_FS_RLF_Thinness.csv")
################################################################################
AVG_FS_RLF_StuntingYoung = data.frame(Importance = double())
...
for (factor in names(StuntingYoung)[1:54]){
  ...
  AVG_FS_RLF_StuntingYoung[[factor, 1]] = sum/100
}
write.csv(AVG_FS_RLF_StuntingYoung, "AVG_FS_RLF_StuntingYoung.csv")
################################################################################
AVG_FS_RLF_ThinnessYoung = data.frame(Importance = double())
...
for (factor in names(thinnessYoung)[1:54]){
  ...
  AVG_FS_RLF_ThinnessYoung[[factor, 1]] = sum/100
}
write.csv(AVG_FS_RLF_ThinnessYoung, "AVG_FS_RLF_ThinnessYoung.csv")
################################################################################
AVG_FS_RLF_WastingYoung = data.frame(Importance = double())
...
for (factor in names(WastingYoung)[1:54]){
  ...
  AVG_FS_RLF_WastingYoung[[factor, 1]] = sum/100
}
write.csv(AVG_FS_RLF_WastingYoung, "AVG_FS_RLF_WastingYoung.csv")
################################################################################
```
...
################################################################################
AVG_FS_IG_Stunting = data.frame(Importance = double())
COPY = FS_IG_Stunting
for (factor in names(stunting)[1:54]){
  sum = 0
  for (i in 1:10){
  ...
  AVG_FS_IG_Stunting[[factor, 1]] = sum/100
}
write.csv(AVG_FS_IG_Stunting, "AVG_IG_IG_Stunting.csv")
################################################################################
AVG_FS_IG_Thinness = data.frame(Importance = double())
COPY = FS_IG_Thinness
for (factor in names(thinness)[1:54]){
  sum = 0
  for (i in 1:10){
  ...
  AVG_FS_IG_Thinness[[factor, 1]] = sum/100
}
write.csv(AVG_FS_IG_Thinness, "AVG_IG_IG_Thinness.csv")
################################################################################
AVG_FS_IG_StuntingYoung = data.frame(Importance = double())
...
for (factor in names(StuntingYoung)[1:54]){
  ...
  AVG_FS_IG_StuntingYoung[[factor, 1]] = sum/100
}
write.csv(AVG_FS_IG_StuntingYoung, "AVG_IG_IG_StuntingYoung.csv")
################################################################################
AVG_FS_IG_ThinnessYoung = data.frame(Importance = double())
...
for (factor in names(thinnessYoung)[1:54]){
  ...
  AVG_FS_IG_ThinnessYoung[[factor, 1]] = sum/100
}
write.csv(AVG_FS_IG_ThinnessYoung, "AVG_IG_IG_ThinnessYoung.csv")
################################################################################
AVG_FS_IG_WastingYoung = data.frame(Importance = double())
...
for (factor in names(WastingYoung)[1:54]){
  ...
  AVG_FS_IG_WastingYoung[[factor, 1]] = sum/100
}
write.csv(AVG_FS_IG_WastingYoung, "AVG_IG_IG_WastingYoung.csv")
################################################################################
```
...
FS_LB_Stunting = list(c(1, 2, 14, 4, 6:18, 19, 21:25, 28, 29, 33:36, 38, 47:54))
FS_LB_Thinness = FS_LB_Stunting
FS_LB_StuntingYoung = FS_LB_Stunting
FS_LB_ThinnessYoung = FS_LB_Stunting
FS_LB_WastingYoung = FS_LB_Stunting
```
...
```{r Multivariate Logistic Regression, warnings = FALSE}
