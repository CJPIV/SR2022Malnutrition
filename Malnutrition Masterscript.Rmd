...
for (i in 1:10){
  for (j in 1:10){
    ...
    for (k in 1:20){ #Look at top 20 most important features
      factor = infogain[[k, 1]]
      if (infogain[[k, 2]] > 0){
...
write.csv(cbind(
          ...
          p.adjust(summary(StepStunting)$coefficients[1:9,4],method = "BH"),
...
write.csv(cbind(
          ...
          p.adjust(summary(StepLINStunting)$coefficients[1:9,4],method = "BH"),
...
data = data.frame(lapply(UBStunting, as.logical))
