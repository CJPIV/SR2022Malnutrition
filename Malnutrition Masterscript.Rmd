...
for (i in 6:62){ #We're removing any factors with imbalances of 95%-5% or worse
  #cat("CURRENT: ", i, "\n")
  factor = table(processed[,i])
  if (factor[[2]] < 50){ # < 5% prevalence
    cat("SHOULD REMOVE: ", names(processed)[[i]], "\n")
  }else if (factor[[2]] > 986){ # > 95% prevalence
    cat("SHOULD REMOVE: ", names(processed)[[i]], "\n")
  }
}
processed = processed[,-c(14, 15, 17, 19, 23, 31, 32, 39, 41, 45:48, 50, 53)]
```
...
stunting = processed[,-c(3, 4, 48, 50:53)]
thinness = processed[,-c(3, 4, 48:50, 52:53)]
wasting = processed[,-c(3, 4, 48:52)]
