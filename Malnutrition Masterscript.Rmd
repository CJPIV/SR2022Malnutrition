...
```{r Removing Variables of Insufficient Prevalence}
#COPY = processed
#processed = COPY

for (i in 6:62){
  #cat("CURRENT: ", i, "\n")
  factor = table(processed[,i])
  # if (is.na(factor[[2]])){ #Removing elements causes us to check out of bounds
  #   break
  # }
  if (factor[[2]] < 50){
    cat("REMOVED: ", names(processed)[[i]], "\n")
    processed = processed[,-i]
    i = i - 1
  }
}
processed = processed[,-c(17, 19)]
```
...
stunting = processed[,-c(3, 4, 54, 56:59)]
thinness = processed[,-c(3, 4, 54:56, 58:59)]
wasting = processed[,-c(3, 4, 54:58)]

#These will be used in Association Rule Learning (last several blocks of code at bottom of this script)
StuntingFull = stunting 
ThinnessFull = thinness
#Wasting 6 lines below
################################################################################
...
WastingFull = wastingYoung #Can only determine wasting for "Young" samples (age < 11)
