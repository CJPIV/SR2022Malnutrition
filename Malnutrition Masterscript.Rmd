...
imputed = subset(imputed, select = 1:41)
testFolds = createFolds(imputed$Stunting, k = 10) #Create k splits

TestStunting = list(imputed[testFolds$Fold01, ], imputed[testFolds$Fold02, ],
                        imputed[testFolds$Fold03, ], imputed[testFolds$Fold04, ],
                        imputed[testFolds$Fold05, ], imputed[testFolds$Fold06, ],
                        imputed[testFolds$Fold07, ], imputed[testFolds$Fold08, ],
                        imputed[testFolds$Fold09, ], imputed[testFolds$Fold10, ]
                        )
################################################################################

TrainValidStunting = list(stunting[-testFolds$Fold01, ], stunting[-testFolds$Fold02, ],
...
ValidStunting = list()
for (i in 1:10){
  curSet = TrainValidStunting[[i]]
  imputed = kNN(curSet, variable = colnames(stunting), k = 5, impNA = TRUE) 
  imputed = subset(imputed, select = 1:41)
  validationFolds = createFolds(TrainValidStunting[[i]]$Stunting, k = 10)
  ValidStunting[[i]] = list(imputed[validationFolds$Fold01, ],
                         imputed[validationFolds$Fold02, ],
                         imputed[validationFolds$Fold03, ],
                         imputed[validationFolds$Fold04, ],
                         imputed[validationFolds$Fold05, ],
                         imputed[validationFolds$Fold06, ],
                         imputed[validationFolds$Fold07, ],
                         imputed[validationFolds$Fold08, ],
                         imputed[validationFolds$Fold09, ],
                         imputed[validationFolds$Fold10, ]
                         )
  ...
  TrainValidStunting[[i]] = imputed
  for (j in 1:10){
    curSet = UBStunting[[i]][[j]]
    imputed = kNN(curSet, variable = colnames(stunting), k = 5, impNA = TRUE) 
    imputed = subset(imputed, select = 1:41)
    UBStunting[[i]][[j]] = imputed
  }
}
SMOTETrainStunting = list()
for (i in 1:10){ #Use SMOTE to create balanced versions of each of the training sets
  SMOTETrainStunting[[i]] = list()
  for (j in 1:10){
    SMOTETrainStunting[[i]][[j]] = SMOTE(X = as.data.frame(UBStunting[[i]][[j]]),
                              target = UBStunting[[i]][[j]]$Stunting,
                              K = 5,
                              dup_size = 1
                              )
     SMOTETrainStunting[[i]][[j]]$data$class = NULL #Extra random variable, breaks modelling
  }
}
SMOTETrainValidStunting = list()
for (i in 1:10){ #Use SMOTE to create balanced versions of each of the training sets
  SMOTETrainValidStunting[[i]]  = SMOTE(X = as.data.frame(TrainValidStunting[[i]]),
                              target = TrainValidStunting[[i]]$Stunting,
                              K = 5,
                              dup_size = 1
                              )
     SMOTETrainValidStunting[[i]]$data$class = NULL #Extra random variable, breaks modelling
}
################################################################################
...
barplot(prop.table(table(SMOTETrainStunting[[1]][[1]]$data$Stunting)),
        col = c("white", "darkgrey"),
        ylim = c(0, 1),
        xlim = c(0, 3),
        ylab = "Prevalence (%)",
...
table(SMOTETrainStunting[[1]][[1]]$data$Stunting)[[1]][[1]]
table(SMOTETrainStunting[[1]][[1]]$data$Stunting)[[2]][[1]]
table(SMOTETrainStunting[[1]][[1]]$data$Stunting)[[1]][[1]]/table(SMOTETrainStunting[[1]][[1]]$data$Stunting)[[2]][[1]]

table(TrainValidStunting[[1]]$Stunting)[[1]][[1]]
table(TrainValidStunting[[1]]$Stunting)[[2]][[1]]
table(TrainValidStunting[[1]]$Stunting)[[1]][[1]]/table(TrainValidStunting[[1]]$Stunting)[[2]][[1]]
table(SMOTETrainValidStunting[[1]]$data$Stunting)[[1]][[1]]
table(SMOTETrainValidStunting[[1]]$data$Stunting)[[2]][[1]]
table(SMOTETrainValidStunting[[1]]$data$Stunting)[[1]][[1]]/table(SMOTETrainValidStunting[[1]]$data$Stunting)[[2]][[1]]
```
...
imputed = subset(imputed, select = 1:41)
testFolds = createFolds(imputed$Thinness, k = 10) #Create k splits

TestThinness = list(imputed[testFolds$Fold01, ], imputed[testFolds$Fold02, ],
                        imputed[testFolds$Fold03, ], imputed[testFolds$Fold04, ],
                        imputed[testFolds$Fold05, ], imputed[testFolds$Fold06, ],
                        imputed[testFolds$Fold07, ], imputed[testFolds$Fold08, ],
                        imputed[testFolds$Fold09, ], imputed[testFolds$Fold10, ]
...
TrainValidThinness = list(Thinness[-testFolds$Fold01, ], Thinness[-testFolds$Fold02, ],
...
ValidThinness = list()
for (i in 1:10){
  curSet = TrainValidThinness[[i]]
  imputed = kNN(curSet, variable = colnames(Thinness), k = 5, impNA = TRUE) 
  imputed = subset(imputed, select = 1:41)
  validationFolds = createFolds(TrainValidThinness[[i]]$Thinness, k = 10)
  ValidThinness[[i]] = list(imputed[validationFolds$Fold01, ],
                         imputed[validationFolds$Fold02, ],
                         imputed[validationFolds$Fold03, ],
                         imputed[validationFolds$Fold04, ],
                         imputed[validationFolds$Fold05, ],
  ...
  TrainValidThinness[[i]] = imputed
  for (j in 1:10){
    curSet = UBThinness[[i]][[j]]
    imputed = kNN(curSet, variable = colnames(Thinness), k = 5, impNA = TRUE) 
    imputed = subset(imputed, select = 1:41)
    UBThinness[[i]][[j]] = imputed
  }
}
SMOTETrainThinness = list()
for (i in 1:10){ #Use SMOTE to create balanced versions of each of the training sets
  SMOTETrainThinness[[i]] = list()
  for (j in 1:10){
    SMOTETrainThinness[[i]][[j]] = SMOTE(X = as.data.frame(UBThinness[[i]][[j]]),
                              target = UBThinness[[i]][[j]]$Thinness,
                              K = 5,
                              dup_size = 9
                              )
     SMOTETrainThinness[[i]][[j]]$data$class = NULL #Extra random variable, breaks modelling
  }
}
SMOTETrainValidThinness = list()
for (i in 1:10){ #Use SMOTE to create balanced versions of each of the training sets
  SMOTETrainValidThinness[[i]]  = SMOTE(X = as.data.frame(TrainValidThinness[[i]]),
                              target = TrainValidThinness[[i]]$Thinness,
                              K = 5,
                              dup_size = 9
                              )
     SMOTETrainValidThinness[[i]]$data$class = NULL #Extra random variable, breaks modelling
}
################################################################################
...
barplot(prop.table(table(SMOTETrainThinness[[1]][[1]]$data$Thinness)),
        col = c("white", "darkgrey"),
        ylim = c(0, 1),
        xlim = c(0, 3),
        ylab = "Prevalence (%)",
...
table(SMOTETrainThinness[[1]][[1]]$data$Thinness)[[1]][[1]]
table(SMOTETrainThinness[[1]][[1]]$data$Thinness)[[2]][[1]]
table(SMOTETrainThinness[[1]][[1]]$data$Thinness)[[1]][[1]]/table(SMOTETrainThinness[[1]][[1]]$data$Thinness)[[2]][[1]]

table(TrainValidThinness[[1]]$Thinness)[[1]][[1]]
table(TrainValidThinness[[1]]$Thinness)[[2]][[1]]
table(TrainValidThinness[[1]]$Thinness)[[1]][[1]]/table(TrainValidThinness[[1]]$Thinness)[[2]][[1]]
table(SMOTETrainValidThinness[[1]]$data$Thinness)[[1]][[1]]
table(SMOTETrainValidThinness[[1]]$data$Thinness)[[2]][[1]]
table(SMOTETrainValidThinness[[1]]$data$Thinness)[[1]][[1]]/table(SMOTETrainValidThinness[[1]]$data$Thinness)[[2]][[1]]
```
...
imputed = subset(imputed, select = 1:41)
testFolds = createFolds(imputed$Wasting, k = 10) #Create k splits

TestWasting = list(imputed[testFolds$Fold01, ], imputed[testFolds$Fold02, ],
                        imputed[testFolds$Fold03, ], imputed[testFolds$Fold04, ],
                        imputed[testFolds$Fold05, ], imputed[testFolds$Fold06, ],
                        imputed[testFolds$Fold07, ], imputed[testFolds$Fold08, ],
                        imputed[testFolds$Fold09, ], imputed[testFolds$Fold10, ]
...
TrainValidWasting = list(Wasting[-testFolds$Fold01, ], Wasting[-testFolds$Fold02, ],
...
ValidWasting = list()
for (i in 1:10){
  curSet = TrainValidWasting[[i]]
  imputed = kNN(curSet, variable = colnames(Wasting), k = 5, impNA = TRUE) 
  imputed = subset(imputed, select = 1:41)
  validationFolds = createFolds(TrainValidWasting[[i]]$Wasting, k = 10)
  ValidWasting[[i]] = list(imputed[validationFolds$Fold01, ],
                         imputed[validationFolds$Fold02, ],
                         imputed[validationFolds$Fold03, ],
                         imputed[validationFolds$Fold04, ],
                         imputed[validationFolds$Fold05, ],
  ...
  TrainValidWasting[[i]] = imputed
  for (j in 1:10){
    curSet = UBWasting[[i]][[j]]
    imputed = kNN(curSet, variable = colnames(Wasting), k = 5, impNA = TRUE) 
    imputed = subset(imputed, select = 1:41)
    UBWasting[[i]][[j]] = imputed
  }
}
SMOTETrainWasting = list()
for (i in 1:10){ #Use SMOTE to create balanced versions of each of the training sets
  SMOTETrainWasting[[i]] = list()
  for (j in 1:10){
    SMOTETrainWasting[[i]][[j]] = SMOTE(X = as.data.frame(UBWasting[[i]][[j]]),
                              target = UBWasting[[i]][[j]]$Wasting,
                              K = 5,
                              dup_size = 3
                              )
     SMOTETrainWasting[[i]][[j]]$data$class = NULL #Extra random variable, breaks modelling
  }
}
SMOTETrainValidWasting = list()
for (i in 1:10){ #Use SMOTE to create balanced versions of each of the training sets
  SMOTETrainValidWasting[[i]]  = SMOTE(X = as.data.frame(TrainValidWasting[[i]]),
                              target = TrainValidWasting[[i]]$Wasting,
                              K = 5,
                              dup_size = 3
                              )
     SMOTETrainValidWasting[[i]]$data$class = NULL #Extra random variable, breaks modelling
}
################################################################################
...
barplot(prop.table(table(SMOTETrainWasting[[1]][[1]]$data$Wasting)),
        col = c("white", "darkgrey"),
        ylim = c(0, 1),
        xlim = c(0, 3),
        ylab = "Prevalence (%)",
...
table(SMOTETrainWasting[[1]][[1]]$data$Wasting)[[1]][[1]]
table(SMOTETrainWasting[[1]][[1]]$data$Wasting)[[2]][[1]]
table(SMOTETrainWasting[[1]][[1]]$data$Wasting)[[1]][[1]]/table(SMOTETrainWasting[[1]][[1]]$data$Wasting)[[2]][[1]]

table(TrainValidWasting[[1]]$Wasting)[[1]][[1]]
table(TrainValidWasting[[1]]$Wasting)[[2]][[1]]
table(TrainValidWasting[[1]]$Wasting)[[1]][[1]]/table(TrainValidWasting[[1]]$Wasting)[[2]][[1]]
table(SMOTETrainValidWasting[[1]]$data$Wasting)[[1]][[1]]
table(SMOTETrainValidWasting[[1]]$data$Wasting)[[2]][[1]]
table(SMOTETrainValidWasting[[1]]$data$Wasting)[[1]][[1]]/table(SMOTETrainValidWasting[[1]]$data$Wasting)[[2]][[1]]
```
...
#####
```{r Classifer Training Set Preparation}
#Creating train sets of selected features from original datasets for use in classifier modelling.
...
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[1]][["MVLoR"]][[i]][[j]] = TRAINING[[1]][["MVLoR"]][[i]][[j]][,c(2,3,5,41)]
  }
}
TRAINING[[1]][["UVLoR"]] = UBStunting
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[1]][["UVLoR"]][[i]][[j]] = TRAINING[[1]][["UVLoR"]][[i]][[j]][,c(1,4,41)]
  }
}
TRAINING[[1]][["IG"]] = NA #IG]]
...
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[1]][["MRMR"]][[i]][[j]] = TRAINING[[1]][["MRMR"]][[i]][[j]][,c(1:4,12,24,26,35,40,41)]
  }
}
TRAINING[[1]][["JMI"]] = UBStunting
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[1]][["JMI"]][[i]][[j]] = TRAINING[[1]][["JMI"]][[i]][[j]][,c(1:4,8,12,13,41)]
  }
}
TRAINING[[1]][["ChiSq"]] = NA
################################################################################
...
TRAINING[[2]][["MVLoR"]] = SMOTEThinness
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[2]][["MVLoR"]][[i]][[j]] = TRAINING[[2]][["MVLoR"]][[i]][[j]]$data[,c(11,17,41)]
  }
}
TRAINING[[2]][["UVLoR"]] = SMOTEThinness
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[2]][["UVLoR"]][[i]][[j]] = TRAINING[[2]][["UVLoR"]][[i]][[j]]$data[,c(3,8,28,29,41)]
  }
}
TRAINING[[2]][["IG"]] = SMOTEThinness
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[2]][["IG"]][[i]][[j]] = TRAINING[[2]][["IG"]][[i]][[j]]$data[,c(13,29,5,24,8,38,23,28,41)]
  }
}
TRAINING[[2]][["MRMR"]] = SMOTEThinness
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[2]][["MRMR"]][[i]][[j]] = TRAINING[[2]][["MRMR"]][[i]][[j]]$data[,c(36,15,3,26,39,35,20,33,41)]
  }
}
TRAINING[[2]][["JMI"]] = SMOTEThinness
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[2]][["JMI"]][[i]][[j]] = TRAINING[[2]][["JMI"]][[i]][[j]]$data[,c(1,28,40,12,13,29,34,4,5,24,35,8,38,35,21,41)]
  }
}
TRAINING[[2]][["ChiSq"]] = SMOTEThinness
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[2]][["ChiSq"]][[i]][[j]] = TRAINING[[2]][["ChiSq"]][[i]][[j]]$data[,c(1,3,29,39,8,32,33,41)]
  }
}
################################################################################
...
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[3]][["MVLoR"]][[i]][[j]] = TRAINING[[3]][["MVLoR"]][[i]][[j]]$data[,c(2,17,41)]
  }
}
TRAINING[[3]][["UVLoR"]] = SMOTEWasting
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[3]][["UVLoR"]][[i]][[j]] = TRAINING[[3]][["UVLoR"]][[i]][[j]]$data[,c(1,16,41)]
  }
}
TRAINING[[3]][["IG"]] = SMOTEWasting
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[3]][["IG"]][[i]][[j]] = TRAINING[[3]][["IG"]][[i]][[j]]$data[,c(1,41)]
  }
}
TRAINING[[3]][["MRMR"]] = SMOTEWasting
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[3]][["MRMR"]][[i]][[j]] = TRAINING[[3]][["MRMR"]][[i]][[j]]$data[,c(1,36,10,11,15,26,17,20,41)]
  }
}
TRAINING[[3]][["JMI"]] = SMOTEWasting #None
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[3]][["JMI"]][[i]][[j]] = TRAINING[[3]][["JMI"]][[i]][[j]]$data[,c(1,2,28,40,11,12,13,29,34,5,24,35,8,38,23,21,41)]
  }
}
TRAINING[[3]][["ChiSq"]] = SMOTEWasting
for (i in 1:10){
  for (j in 1:10){
    TRAINING[[3]][["ChiSq"]][[i]][[j]] = TRAINING[[3]][["ChiSq"]][[i]][[j]]$data[,c(1,16,20,41)]
  }
}
```
...
```{r Classifier Validation Set Preparation, warning = FALSE}
#Creating validation sets of selected features from original datasets for use in classifier modelling.
VALID = list(Stunting = list(None = list(),
                                MVLoR = list(),
                                UVLoR = list(),
                                IG = list(),
                                MRMR = list(),
...
################################################################################
VALID[[1]][["None"]] = validSetsStunting
for (i in 1:10){
  for (j in 1:10){
    VALID[[1]][["None"]][[i]][[j]] = stunting[VALID[[1]][[1]][[i]][[j]],]
  }
}
VALID[[1]][["MVLoR"]] = validSetsStunting
for (i in 1:10){
  for (j in 1:10){
    VALID[[1]][["MVLoR"]][[i]][[j]] = stunting[VALID[[1]][[2]][[i]][[j]],][,c(2,3,5,41)]
  }
}
VALID[[1]][["UVLoR"]] = validSetsStunting
for (i in 1:10){
  for (j in 1:10){
    VALID[[1]][["UVLoR"]][[i]][[j]] = stunting[VALID[[1]][["UVLoR"]][[i]][[j]],][,c(1,4,41)]
  }
}
VALID[[1]][["IG"]] = NA
VALID[[1]][["MRMR"]] = validSetsStunting
for (i in 1:10){
  for (j in 1:10){
    VALID[[1]][["MRMR"]][[i]][[j]] = stunting[VALID[[1]][["MRMR"]][[i]][[j]],][,c(1:4,12,24,26,35,40,41)]
  }
}
VALID[[1]][["JMI"]] = validSetsStunting
for (i in 1:10){
  for (j in 1:10){
    VALID[[1]][["JMI"]][[i]][[j]] = stunting[VALID[[1]][["JMI"]][[i]][[j]],][,c(1:4,8,12,13,41)]
  }
}
VALID[[1]][["ChiSq"]] = NA
################################################################################
VALID[[2]][["None"]] = validSetsThinness
for (i in 1:10){
  for (j in 1:10){
    VALID[[2]][["None"]][[i]][[j]] = thinness[VALID[[2]][["None"]][[i]][[j]],]
  }
}
VALID[[2]][["MVLoR"]] = validSetsThinness
for (i in 1:10){
  for (j in 1:10){
    VALID[[2]][["MVLoR"]][[i]][[j]] = thinness[VALID[[2]][["MVLoR"]][[i]][[j]],][,c(11,17,41)]
  }
}
VALID[[2]][["UVLoR"]] = validSetsThinness
for (i in 1:10){
  for (j in 1:10){
    VALID[[2]][["UVLoR"]][[i]][[j]] = thinness[VALID[[2]][["UVLoR"]][[i]][[j]],][,c(3,8,28,29,41)]
  }
}
VALID[[2]][["IG"]] = validSetsThinness
for (i in 1:10){
  for (j in 1:10){
    VALID[[2]][["IG"]][[i]][[j]] = thinness[VALID[[2]][["IG"]][[i]][[j]],][,c(13,29,5,24,8,38,23,28,41)]
  }
}
VALID[[2]][["MRMR"]] = validSetsThinness
for (i in 1:10){
  for (j in 1:10){
    VALID[[2]][["MRMR"]][[i]][[j]] = thinness[VALID[[2]][["MRMR"]][[i]][[j]],][,c(36,15,3,26,39,35,20,33,41)]
  }
}
VALID[[2]][["JMI"]] = validSetsThinness
for (i in 1:10){
  for (j in 1:10){
    VALID[[2]][["JMI"]][[i]][[j]] = thinness[VALID[[2]][["JMI"]][[i]][[j]],][,c(1,28,40,12,13,29,34,4,5,24,35,8,38,35,21,41)]
  }
}
VALID[[2]][["ChiSq"]] = validSetsThinness
for (i in 1:10){
  for (j in 1:10){
    VALID[[2]][["ChiSq"]][[i]][[j]] = thinness[VALID[[2]][["ChiSq"]][[i]][[j]],][,c(1,3,29,39,8,32,33,41)]
  }
}
################################################################################
VALID[[3]][["None"]] = validSetsWasting
for (i in 1:10){
  for (j in 1:10){
    VALID[[3]][["None"]][[i]][[j]] = wasting[VALID[[3]][["None"]][[i]][[j]],]
  }
}
VALID[[3]][["MVLoR"]] = validSetsWasting
for (i in 1:10){
  for (j in 1:10){
    VALID[[3]][["MVLoR"]][[i]][[j]] = wasting[VALID[[3]][["MVLoR"]][[i]][[j]],][,c(2,17,41)]
  }
}
VALID[[3]][["UVLoR"]] = validSetsWasting
for (i in 1:10){
  for (j in 1:10){
    VALID[[3]][["UVLoR"]][[i]][[j]] = wasting[VALID[[3]][["UVLoR"]][[i]][[j]],][,c(1,16,41)]
  }
}
VALID[[3]][["IG"]] = validSetsWasting
for (i in 1:10){
  for (j in 1:10){
    VALID[[3]][["IG"]][[i]][[j]] = wasting[VALID[[3]][["IG"]][[i]][[j]],][,c(1,41)]
  }
}
VALID[[3]][["MRMR"]] = validSetsWasting
for (i in 1:10){
  for (j in 1:10){
    VALID[[3]][["MRMR"]][[i]][[j]] = wasting[VALID[[3]][["MRMR"]][[i]][[j]],][,c(1,36,10,11,15,26,17,20,41)]
  }
}
VALID[[3]][["JMI"]] = validSetsWasting #None
for (i in 1:10){
  for (j in 1:10){
    VALID[[3]][["JMI"]][[i]][[j]] = wasting[VALID[[3]][["JMI"]][[i]][[j]],][,c(1,2,28,40,11,12,13,29,34,5,24,35,8,38,23,21,41)]
  }
}
VALID[[3]][["ChiSq"]] = validSetsWasting #None
for (i in 1:10){
  for (j in 1:10){
    VALID[[3]][["ChiSq"]][[i]][[j]] = wasting[VALID[[3]][["ChiSq"]][[i]][[j]],][,c(1,16,20,41)]
  }
}
```
...
```{r Train Feature Selection, warning = FALSE}
library(FSelectorRcpp)
library(broom)
#Prepare list to hold subsets determined by feature selection
TRAIN = list(Stunting = list(None = list(),
                                MVLoR = list(),
                                UVLoR = list(),
                                IG = list(),
                                MRMR = list(),
...
for (i in 1:3){
  for (j in 1:7){
    for (k in 1:10){
      TRAIN[[i]][[j]][[k]] = list()
      for (l in 1:10){}
        TRAIN[[i]][[j]][[k]][[l]] = list() #Create list for each subset; to be filled with selected indices as determined by new FS
        TRAIN[[i]][[j]][[k]][[l]][[1]] = list()
        TRAIN[[i]][[j]][[k]][[l]][[2]] = list()
        names(TRAIN[[i]][[j]][[k]][[l]])[[1]] = paste0("TRAIN_",k)
        names(TRAIN[[i]][[j]][[k]][[l]])[[2]] = paste0("TEST_",k)
    }
  }
}
################################################################################
...
for (k in 1:10){
  for (l in 1:10){
    TRAIN[[1]][[1]][[k]][[l]][[1]] = UBStunting[[k]][[l]]
    TRAIN[[1]][[1]][[k]][[l]][[2]] = ValidStunting[[k]][[l]]
  }
}
for (k in 1:10){
  for (l in 1:10){
    TRAIN[[2]][[1]][[k]][[l]][[1]] = SMOTETrainThinness[[k]][[l]]$data
    TRAIN[[2]][[1]][[k]][[l]][[2]] = ValidThinness[[k]][[l]]
  }
}
for (k in 1:10){
  for (l in 1:10){
    TRAIN[[3]][[1]][[k]][[l]][[1]] = SMOTETrainWasting[[k]][[l]]$data
    TRAIN[[3]][[1]][[k]][[l]][[2]] = ValidWasting[[k]][[l]]
  }
}
################################################################################
#MVLoR
...
#Stunting
  for (j in 1:10){
    for (k in 1:10){
    index = 0
    MVLoR = glm(formula = Stunting~.,
                data = as.data.frame(UBStunting[[j]][[k]]),
                family = "binomial"
                )
    regSummary = tidy(MVLoR, exponentiate = TRUE, conf.level = 0.95)
    
    factors = data.frame(PV = double())
    for (i in 1:40){
      factors[i,] = 0
    }
    row.names(factors) = names(stunting)[1:40]
    
    for (factor in names(stunting)[1:40]){
      index = index + 1
      if (!is.na(regSummary[[index, 5]])){
        factors[[factor, 1]] =  regSummary[[index+1, 5]]
      }
    }
    factors = order(factors$PV)[1:10]
    TRAIN[[1]][[2]][[j]][[k]][[1]] = UBStunting[[j]][[k]][,factors]
    TRAIN[[1]][[2]][[j]][[k]][[2]] = ValidStunting[[j]][[k]][,factors]
    }}
#Thinness
for (j in 1:10){
  for (k in 1:10){
    index = 0
    MVLoR = glm(formula = Thinness~.,
                data = as.data.frame(SMOTETrainThinness[[j]][[k]]$data),
                family = "binomial"
                )
    regSummary = tidy(MVLoR, exponentiate = TRUE, conf.level = 0.95)
    ...
    row.names(factors) = names(Thinness)[1:40]
    
    for (factor in names(Thinness)[1:40]){
      index = index + 1
      if (!is.na(regSummary[[index, 5]])){
        factors[[factor, 1]] =  regSummary[[index+1, 5]]
      }
    ...
    factors = order(factors$PV)[1:10]
    TRAIN[[2]][[2]][[j]][[k]][[1]] = SMOTETrainThinness[[j]][[k]]$data[,factors]
    TRAIN[[2]][[2]][[j]][[k]][[2]] = ValidThinness[[j]][[k]][,factors]
  }}
#Wasting
for (j in 1:10){
  for (k in 1:10){
    index = 0
    MVLoR = glm(formula = Wasting~.,
                data = as.data.frame(SMOTETrainWasting[[j]][[k]]$data),
                family = "binomial"
                )
    regSummary = tidy(MVLoR, exponentiate = TRUE, conf.level = 0.95)
    ...
    row.names(factors) = names(Wasting)[1:40]
    
    for (factor in names(Wasting)[1:40]){
      index = index + 1
      if (!is.na(regSummary[[index, 5]])){
        factors[[factor, 1]] =  regSummary[[index+1, 5]]
      }
    ...
    factors = order(factors$PV)[1:10]
    TRAIN[[3]][[2]][[j]][[k]][[1]] = SMOTETrainWasting[[j]][[k]]$data[,factors]
    TRAIN[[3]][[2]][[j]][[k]][[2]] = ValidWasting[[j]][[k]][,factors]
}}
################################################################################
#UVLoR
...
for (j in 1:10){
  ...
  for (factor in names(stunting)[1:40]){
    UVLoR = glm(formula = paste0("Stunting~",factor),
                data = as.data.frame(UBStunting[[j]][[k]]),
                family = "binomial"
                )
    regSummary = tidy(UVLoR, exponentiate = TRUE, conf.level = 0.95)
    factors[[factor,1]] = regSummary[[2,5]]
  }
  factors = order(factors$PV)[1:10]
  TRAIN[[1]][[3]][[j]][[k]][[1]] = UBStunting[[j]][[k]][,factors]
  TRAIN[[1]][[3]][[j]][[k]][[2]] = ValidStunting[[j]][[k]][,factors]
}}
...
for (j in 1:10){
  ...
  for (factor in names(stunting)[1:40]){
    UVLoR = glm(formula = paste0("Thinness~",factor),
                data = as.data.frame(SMOTETrainThinness[[j]][[k]]$data),
                family = "binomial"
                )
    regSummary = tidy(UVLoR, exponentiate = TRUE, conf.level = 0.95)
  ...
  factors = order(factors$PV)[1:10]
  TRAIN[[2]][[3]][[j]][[k]][[1]] = SMOTETrainThinness[[j]][[k]]$data[,factors]
  TRAIN[[2]][[3]][[j]][[k]][[2]] = ValidThinness[[j]][[k]][,factors]
  }}
...
for (j in 1:10){
  ...
  for (factor in names(stunting)[1:40]){
    UVLoR = glm(formula = paste0("Wasting~",factor),
                data = as.data.frame(SMOTETrainWasting[[j]][[k]]$data),
                family = "binomial"
                )
    regSummary = tidy(UVLoR, exponentiate = TRUE, conf.level = 0.95)
  ...
  factors = order(factors$PV)[1:10]
  TRAIN[[3]][[3]][[j]][[k]][[1]] = SMOTETrainWasting[[j]][[k]]$data[,factors]
  TRAIN[[3]][[3]][[j]][[k]][[2]] = ValidWasting[[j]][[k]][,factors]
}}
################################################################################
#InfoGain
...
for (j in 1:10){
  ...
  factors = c()
  for (l in 1:10){ #Look at top 10 most important features
    if (infogain$importance[l] == 0){
      next
    }
    feature = infogain[[l, 1]]
    index = which(names(stunting) == feature)
    factors[l] = index
  }
  TRAIN[[1]][[4]][[j]][[k]][[1]] = UBStunting[[j]][[k]][,factors]
  TRAIN[[1]][[4]][[j]][[k]][[2]] = ValidStunting[[j]][[k]][,factors]
}}
...
for (j in 1:10){
  ...
  TRAIN[[2]][[4]][[j]][[k]][[1]] = SMOTETrainThinness[[j]][[k]]$data[,factors]
  TRAIN[[2]][[4]][[j]][[k]][[2]] = ValidThinness[[j]][[k]][,factors]
  }}
...
for (j in 1:10){
  ...
  TRAIN[[3]][[4]][[j]][[k]][[1]] = SMOTETrainWasting[[j]][[k]]$data[,factors]
  TRAIN[[3]][[4]][[j]][[k]][[2]] = ValidWasting[[j]][[k]][,factors]
}}
...
for (j in 1:10){
  for (k in 1:10){
  mrmr = mRMR.data(data = as.data.frame(UBStunting[[j]][[k]]))
  results = mRMR.classic("mRMRe.Filter",
                           data = mrmr,
                           target_indices = 41,
                           feature_count = 10,
  ...
  factors = c()
  for (l in 1:10){
    factors[l] = results@filters[["41"]][[l,1]]
  }
  TRAIN[[1]][[5]][[j]][[k]][[1]] = UBStunting[[j]][[k]][,factors]
  TRAIN[[1]][[5]][[j]][[k]][[2]] = ValidStunting[[j]][[k]][,factors]
  }}

for (j in 1:10){
  for (k in 1:10){
  mrmr = mRMR.data(data = as.data.frame(SMOTETrainThinness[[j]][[k]]$data))
  results = mRMR.classic("mRMRe.Filter",
                           data = mrmr,
                           target_indices = 41,
                           feature_count = 10,
  ...
  TRAIN[[2]][[5]][[j]][[k]][[1]] = SMOTETrainThinness[[j]][[k]]$data[,factors]
  TRAIN[[2]][[5]][[j]][[k]][[2]] = ValidThinness[[j]][[k]][,factors]
  }}

for (j in 1:10){
  for (k in 1:10){
  mrmr = mRMR.data(data = as.data.frame(SMOTETrainWasting[[j]][[k]]$data))
  results = mRMR.classic("mRMRe.Filter",
                           data = mrmr,
                           target_indices = 41,
                           feature_count = 10,
  ...
  TRAIN[[3]][[5]][[j]][[k]][[1]] = SMOTETrainWasting[[j]][[k]]$data[,factors]
  TRAIN[[3]][[5]][[j]][[k]][[2]] = ValidWasting[[j]][[k]][,factors]
  }}
...
library(praznik)
  ...
  for (j in 1:10){
    for (k in 1:10){
    jmi = JMI(as.data.frame(UBStunting[[j]][[k]][-ncol(UBStunting[[j]][[k]])]),
          as.vector(UBStunting[[j]][[k]][,ncol(UBStunting[[j]][[k]])]),
          k = 10
          )
    factors = c()
    for (l in 1:10){
      factors[l] = jmi$selection[[l]]
    }
    TRAIN[[1]][[6]][[j]][[k]][[1]] = UBStunting[[j]][[k]][,factors]
    TRAIN[[1]][[6]][[j]][[k]][[2]] = ValidStunting[[j]][[k]][,factors]
    }}

for (j in 1:10){
  for (k in 1:10){
    jmi = JMI(as.data.frame(SMOTETrainThinness[[j]][[k]]$data[-ncol(SMOTETrainThinness[[j]][[k]]$data)]),
          as.vector(SMOTETrainThinness[[j]][[k]]$data[,ncol(SMOTETrainThinness[[j]][[k]]$data)]),
          k = 10
          )
    factors = c()
    for (l in 1:10){
    ...
    TRAIN[[2]][[6]][[j]][[k]][[1]] = SMOTETrainThinness[[j]][[k]]$data[,factors]
    TRAIN[[2]][[6]][[j]][[k]][[2]] = ValidThinness[[j]][[k]][,factors]
  }}

for (j in 1:10){
  for (k in 1:10){
    jmi = JMI(as.data.frame(SMOTETrainWasting[[j]][[k]]$data[-ncol(SMOTETrainWasting[[j]][[k]]$data)]),
          as.vector(SMOTETrainWasting[[j]][[k]]$data[,ncol(SMOTETrainWasting[[j]][[k]]$data)]),
          k = 10
          )
    factors = c()
    for (l in 1:10){
    ...
    TRAIN[[3]][[6]][[j]][[k]][[1]] = SMOTETrainWasting[[j]][[k]]$data[,factors]
    TRAIN[[3]][[6]][[j]][[k]][[2]] = ValidWasting[[j]][[k]][,factors]
  }}
...
for (j in 1:10){
  ...
  row.names(factors) = names(stunting)[1:40]
  for (factor in 1:40){
    chisq = chisq.test(table(UBStunting[[j]][[k]][,factor],
                               UBStunting[[j]][[k]]$Stunting)
                         )
    if (chisq$p.value < 0.05){
      factors[[factor, 1]] = chisq$p.value
    }
  }
  factors = order(factors$PV)[1:10]
  TRAIN[[1]][[7]][[j]][[k]][[1]] = UBStunting[[j]][[k]][,factors]
  TRAIN[[1]][[7]][[j]][[k]][[2]] = ValidStunting[[j]][[k]][,factors]
  }}
...
for (j in 1:10){
  ...
  row.names(factors) = names(stunting)[1:40]
  for (factor in 1:40){
    chisq = chisq.test(table(SMOTETrainThinness[[j]][[k]]$data[,factor],
                               SMOTETrainThinness[[j]][[k]]$data$Thinness)
                         )
    if (chisq$p.value < 0.05){
      factors[[factor, 1]] = chisq$p.value
    }
  ...
  factors = order(factors$PV)[1:10]
  TRAIN[[2]][[7]][[j]][[k]][[1]] = SMOTETrainThinness[[j]][[k]]$data[,factors]
  TRAIN[[2]][[7]][[j]][[k]][[2]] = ValidThinness[[j]][[k]][,factors]
  }}
...
for (j in 1:10){
  ...
  row.names(factors) = names(stunting)[1:40]
  for (factor in 1:40){
    chisq = chisq.test(table(SMOTETrainWasting[[j]][[k]]$data[,factor],
                               SMOTETrainWasting[[j]][[k]]$data$Wasting)
                         )
    if (chisq$p.value < 0.05){
      factors[[factor, 1]] = chisq$p.value
    }
  ...
  factors = order(factors$PV)[1:10]
  TRAIN[[3]][[7]][[j]][[k]][[1]] = SMOTETrainWasting[[j]][[k]]$data[,factors]
  TRAIN[[3]][[7]][[j]][[k]][[2]] = ValidWasting[[j]][[k]][,factors]
  }}
...
```{r Multivariate Logistic Regression for Classification, warning = FALSE}
set.seed(13)
library(broom)
library(car)
library(performance)
...
Scores_MVLoR = list(Stunting = list(None = list(Accuracy = 0, F1 = 0),
                                MVLoR = list(Accuracy = 0, F1 = 0),
                                UVLoR = list(Accuracy = 0, F1 = 0),
                                IG = list(Accuracy = 0, F1 = 0),
                                MRMR = list(Accuracy = 0, F1 = 0),
                                JMI = list(Accuracy = 0, F1 = 0),
                                ChiSq = list(Accuracy = 0, F1 = 0)
                                ),
                Thinness = list(None = list(Accuracy = 0, F1 = 0),
                                MVLoR = list(Accuracy = 0, F1 = 0),
                                UVLoR = list(Accuracy = 0, F1 = 0),
                                IG = list(Accuracy = 0, F1 = 0),
                                MRMR = list(Accuracy = 0, F1 = 0),
                ...
                Wasting = list(None = list(Accuracy = 0, F1 = 0),
                                MVLoR = list(Accuracy = 0, F1 = 0),
                                UVLoR = list(Accuracy = 0, F1 = 0),
                                IG = list(Accuracy = 0, F1 = 0),
                                MRMR = list(Accuracy = 0, F1 = 0),
...
for (i in 1:3){ #3 response sets (Stunting, Thinness, Wasting)
  #if (i > 1){break}
  for (j in 1:7){ #7 feature selection (FS) sets
    for (k in 1:10){ #10 test sets total
      for (l in 1:10){ #10 train/validation sets per test set
        train = TRAIN[[i]][[j]][[k]][[l]][[1]] #Import & coerce to matrix in order to scale
        if (length(ncol(train)) == 0){
          next
        }
        if (ncol(train) == 0){
          next
        }
        train[,ncol(train)] = as.factor(train[,ncol(train)]) #Set response as factor
        
        test = TRAIN[[i]][[j]][[k]][[l]][[2]] #Prepare test; 1 test set for 10 train/valid sets (seen below)
        if (nrow(table(test[,ncol(test)])) != 2){ #Should be both 0s and 1s as response vars
          next
        }
        test[,ncol(test)] = as.factor(test[,ncol(test)])

        MVLoR = glm(paste0(names(train)[ncol(train)], "~."), #"glm(Stunting~.),
                    data = train,
                    family = "binomial"
                    )
        y_pred = predict(MVLoR, newdata = test[-ncol(test)], type = "response")
        y_pred = unname(1*(y_pred >= 0.5))
        CM = confusionMatrix(data = as.factor(y_pred),
                             reference = test[,ncol(test)]
                             )
        ...
        Scores_MVLoR[[i]][[j]][[1]] = Scores_MVLoR[[i]][[j]][[1]] + accuracy
        Scores_MVLoR[[i]][[j]][[2]] = Scores_MVLoR[[i]][[j]][[2]] + F1
        if(F1 > best$F1){
      ...
      Scores_MVLoR[[i]][[j]][[1]] = Scores_MVLoR[[i]][[j]][[1]]/100
      Scores_MVLoR[[i]][[j]][[2]] = Scores_MVLoR[[i]][[j]][[2]]/100
    }}
```
...
Scores_RF = list(Stunting = list(None = list(Accuracy = 0, F1 = 0),
                                MVLoR = list(Accuracy = 0, F1 = 0),
                                UVLoR = list(Accuracy = 0, F1 = 0),
                                IG = list(Accuracy = 0, F1 = 0),
                                MRMR = list(Accuracy = 0, F1 = 0),
  ...
  for (j in 1:7){ #7 feature selection (FS) sets
    for (k in 1:10){ #10 test sets total
      for (l in 1:10){ #10 train/validation sets per test set
        ...
        valid = TRAIN[[i]][[j]][[k]][[l]][[2]]
        if (nrow(table(valid[,ncol(valid)])) != 2){ #Should be both 0s and 1s as response vars
          next
        }
        train[,ncol(train)] = as.factor(train[,ncol(train)]) #Set response as factor
        ...
        y_pred = predict(RF, newdata = as.matrix(valid[-ncol(valid)]))
        #y_pred = 1*(y_pred >= 0.5)
        CM = confusionMatrix(data = y_pred,
                             reference = as.factor(valid[,ncol(valid)])
                             )
        accuracy = CM$overall[["Accuracy"]]
        if (is.na(CM$byClass[["F1"]])){
          F1 = 0
        ...
        #cat(accuracy)
        #cat(F1)
        Scores_RF[[i]][[j]][[1]] = Scores_RF[[i]][[j]][[1]] + accuracy
        Scores_RF[[i]][[j]][[2]] = Scores_RF[[i]][[j]][[2]] + F1
        if(F1 > best$F1){
          best$accuracy = accuracy
          best$RS = i
          best$FS = j
      ...
      Scores_RF[[i]][[j]][[1]] = Scores_RF[[i]][[j]][[1]]/100
      Scores_RF[[i]][[j]][[2]] = Scores_RF[[i]][[j]][[2]]/100
    }}
...
```{r Support Vector Machine, warning = FALSE}
set.seed(13)
library(e1071)
library(Matrix)

Scores_SVM = list(Stunting = list(None = list(Accuracy = 0, F1 = 0),
                                MVLoR = list(Accuracy = 0, F1 = 0),
                                UVLoR = list(Accuracy = 0, F1 = 0),
                                IG = list(Accuracy = 0, F1 = 0),
                                MRMR = list(Accuracy = 0, F1 = 0),
...
for (i in 1:3){ #3 response sets (Stunting, Thinness, Wasting)
  #if (i > 1){break}
  for (j in 1:7){ #7 feature selection (FS) sets
    if (length(TRAINING[[i]][[j]]) == 1){
      next
    }
    for (k in 1:10){ #10 test sets total
      for (l in 1:10){ #10 train/validation sets per test set
        train = TRAINING[[i]][[j]][[k]][[l]] #Import & coerce to matrix in order to scale
        valid = VALID[[i]][[j]][[k]][[l]]
        if (length(range(valid[,ncol(valid)])) != 2){ #Should be both 0s and 1s as response vars
          next
        }else if (range(valid[,ncol(valid)])[2] != 1){
          next
        }
        train[,ncol(train)] = as.factor(train[,ncol(train)]) #Set response as factor
        valid[,ncol(valid)] = as.factor(valid[,ncol(valid)])
        ...
        svmGrid = expand.grid(C = 0.15
                              )
        SVM = train(x = train[-ncol(train)],
                           y = train[,ncol(train)],
                           method = 'svmLinear',
                           metric = 'F1',
                           tuneGrid = svmGrid,
        ...
        y_pred = predict(SVM, newdata = as.matrix(valid[-ncol(valid)]))
        #y_pred = 1*(y_pred >= 0.5)
        CM = confusionMatrix(data = y_pred,
                             reference = as.factor(valid[,ncol(valid)])
                             )
        accuracy = CM$overall[["Accuracy"]]
        F1 = CM$byClass[["F1"]]
        Scores_SVM[[i]][[j]][[1]] = Scores_SVM[[i]][[j]][[1]] + accuracy
        Scores_SVM[[i]][[j]][[2]] = Scores_SVM[[i]][[j]][[2]] + F1
        if(F1 > best$F1){
          best$accuracy = accuracy
          best$RS = i
          best$FS = j
      ...
      Scores_SVM[[i]][[j]][[1]] = Scores_SVM[[i]][[j]][[1]]/100
      Scores_SVM[[i]][[j]][[2]] = Scores_SVM[[i]][[j]][[2]]/100
    }}
```



```{r Extreme Gradient Boosting, results = FALSE, warning = FALSE}
set.seed(13)
library(xgboost)
library(caret)
library(tidyverse)

# Esto se trata de usar XGBoost para regressión o classificación. Todavía tengo que implementar este algoritmo, pero supongo que yo sé los fundamentales.
# Я тоже хочу сделать что-то о тех, что мы расговаривали. Наша модель ещё не работает достаточно хорошо за публикации, и так мне надо эту сделать лучше.

Scores_XGB = list(Stunting = list(None = list(Accuracy = 0, F1 = 0),
                                MVLoR = list(Accuracy = 0, F1 = 0),
                                UVLoR = list(Accuracy = 0, F1 = 0),
                                IG = list(Accuracy = 0, F1 = 0),
                                MRMR = list(Accuracy = 0, F1 = 0),
...
xgb.set.config(verbosity = 0) #don't print training update messages
...
for (i in 1:3){ #3 response sets (Stunting, Thinness, Wasting)
  for (j in 1:7){ #7 feature selection (FS) sets
    ...
    for (k in 1:10){ #10 test sets total
      for (l in 1:10){ #10 train/validation sets per test set
        ...
        xgbGrid <- expand.grid(nrounds = c(50),#,100),  
                       ...
                       colsample_bytree = seq(0.1),#, 0.5, length.out = 5),
        ...
        y_pred = predict(XGB, newdata = as.matrix(valid[-ncol(valid)]))
        #y_pred = 1*(y_pred >= 0.5)
        CM = confusionMatrix(data = y_pred,
                             reference = as.factor(valid[,ncol(valid)])
                             )
        accuracy = CM$overall[["Accuracy"]]
        F1 = CM$byClass[["F1"]]
        Scores_XGB[[i]][[j]][[1]] = Scores_XGB[[i]][[j]][[1]] + accuracy
        Scores_XGB[[i]][[j]][[2]] = Scores_XGB[[i]][[j]][[2]] + F1
        if(F1 > best$F1){
          best$accuracy = accuracy
          best$RS = i
          best$FS = j
    ...
    Scores_XGB[[i]][[j]][[1]] = Scores_XGB[[i]][[j]][[1]]/100
    Scores_XGB[[i]][[j]][[2]] = Scores_XGB[[i]][[j]][[2]]/100
    }}
#best
```
...
```{r Trainvalid Feature Selection, warning = FALSE}
library(FSelectorRcpp)
library(broom)
#Prepare list to hold subsets determined by feature selection
TRAINVALID = list(Stunting = list(None = list(),
                                MVLoR = list(),
                                UVLoR = list(),
                                IG = list(),
                                MRMR = list(),
...
for (i in 1:3){
  for (j in 1:7){
    for (k in 1:10){
      TRAINVALID[[i]][[j]][[k]] = list() #Create list for each subset; to be filled with selected indices as determined by new FS
      TRAINVALID[[i]][[j]][[k]][[1]] = list()
      TRAINVALID[[i]][[j]][[k]][[2]] = list()
      names(TRAINVALID[[i]][[j]][[k]])[[1]] = paste0("TRAIN_",k)
      names(TRAINVALID[[i]][[j]][[k]])[[2]] = paste0("TEST_",k)
    }
  }
}
################################################################################
#No feature selection
for (k in 1:10){
  TRAINVALID[[1]][[1]][[k]][[1]] = TrainValidStunting[[k]]
  TRAINVALID[[1]][[1]][[k]][[2]] = TestStunting[[k]]
}
for (k in 1:10){
  TRAINVALID[[2]][[1]][[k]][[1]] = TrainValidThinness[[k]]
  TRAINVALID[[2]][[1]][[k]][[2]] = TestThinness[[k]]
}
for (k in 1:10){
  TRAINVALID[[3]][[1]][[k]][[1]] = TrainValidWasting[[k]]
  TRAINVALID[[3]][[1]][[k]][[2]] = TestWasting[[k]]
}
################################################################################
#MVLoR
  for (j in 1:10){
    index = 0
    MVLoR = glm(formula = Stunting~.,
                data = as.data.frame(TrainValidStunting[[j]]),
                family = "binomial"
                )
    regSummary = tidy(MVLoR, exponentiate = TRUE, conf.level = 0.95)
    ...
    factors = order(factors$PV)[1:10]
    TRAINVALID[[1]][[2]][[j]][[1]] = TrainValidStunting[[j]][,factors]
    TRAINVALID[[1]][[2]][[j]][[2]] = TestStunting[[j]][,factors]
  }
for (j in 1:10){
    index = 0
    MVLoR = glm(formula = Thinness~.,
                data = as.data.frame(TrainValidThinness[[j]]),
                family = "binomial"
                )
    regSummary = tidy(MVLoR, exponentiate = TRUE, conf.level = 0.95)
    ...
    factors = order(factors$PV)[1:10]
    TRAINVALID[[2]][[2]][[j]][[1]] = TrainValidThinness[[j]][,factors]
    TRAINVALID[[2]][[2]][[j]][[2]] = TestThinness[[j]][,factors]
}
for (j in 1:10){
    index = 0
    MVLoR = glm(formula = Wasting~.,
                data = as.data.frame(TrainValidWasting[[j]]),
                family = "binomial"
                )
    regSummary = tidy(MVLoR, exponentiate = TRUE, conf.level = 0.95)
    ...
    factors = order(factors$PV)[1:10]
    TRAINVALID[[3]][[2]][[j]][[1]] = TrainValidWasting[[j]][,factors]
    TRAINVALID[[3]][[2]][[j]][[2]] = TestWasting[[j]][,factors]
  }
################################################################################
#UVLoR
...
for (j in 1:10){
  ...
  factors = order(factors$PV)[1:10]
  TRAINVALID[[1]][[3]][[j]][[1]] = TrainValidStunting[[j]][,factors]
  TRAINVALID[[1]][[3]][[j]][[2]] = TestStunting[[j]][,factors]
}
...
for (j in 1:10){
  ...
  factors = order(factors$PV)[1:10]
  TRAINVALID[[2]][[3]][[j]][[1]] = TrainValidThinness[[j]][,factors]
  TRAINVALID[[2]][[3]][[j]][[2]] = TestThinness[[j]][,factors]
}
for (j in 1:10){
  factors = data.frame(PV = double())
  for (i in 1:40){
  ...
  factors = order(factors$PV)[1:10]
  TRAINVALID[[3]][[3]][[j]][[1]] = TrainValidWasting[[j]][,factors]
  TRAINVALID[[3]][[3]][[j]][[2]] = TestWasting[[j]][,factors]
}
################################################################################
#InfoGain
...
for (j in 1:10){
  ...
  factors = c()
  for (k in 1:10){ #Look at top 10 most important features
    factors[k] = infogain[[k, 1]]
  }
  TRAINVALID[[1]][[4]][[j]][[1]] = TrainValidStunting[[j]][,factors]
  TRAINVALID[[1]][[4]][[j]][[2]] = TestStunting[[j]][,factors]
}
...
for (j in 1:10){
  ...
  TRAINVALID[[2]][[4]][[j]][[1]] = TrainValidThinness[[j]][,factors]
  TRAINVALID[[2]][[4]][[j]][[2]] = TestThinness[[j]][,factors]
}
for (j in 1:10){
  infogain = information_gain(formula = Wasting~.,
                              data = as.data.frame(TrainValidWasting[[j]]),
  ...
  TRAINVALID[[3]][[4]][[j]][[1]] = TrainValidWasting[[j]][,factors]
  TRAINVALID[[3]][[4]][[j]][[2]] = TestWasting[[j]][,factors]
}
...
for (j in 1:10){
  mrmr = mRMR.data(data = as.data.frame(TrainValidStunting[[j]]))
  results = mRMR.classic("mRMRe.Filter",
                           data = mrmr,
                           target_indices = 41,
                           feature_count = 10,
  ...
  factors = c()
  for (k in 1:10){
    factors[k] = results@filters[["41"]][[k,1]]
  }
  TRAINVALID[[1]][[5]][[j]][[1]] = TrainValidStunting[[j]][,factors]
  TRAINVALID[[1]][[5]][[j]][[2]] = TestStunting[[j]][,factors]
}
for (j in 1:10){
  mrmr = mRMR.data(data = as.data.frame(TrainValidThinness[[j]]))
  results = mRMR.classic("mRMRe.Filter",
                           data = mrmr,
                           target_indices = 41,
                           feature_count = 10,
  ...
  TRAINVALID[[2]][[5]][[j]][[1]] = TrainValidThinness[[j]][,factors]
  TRAINVALID[[2]][[5]][[j]][[2]] = TestThinness[[j]][,factors]
}
for (j in 1:10){
  mrmr = mRMR.data(data = as.data.frame(TrainValidWasting[[j]]))
  results = mRMR.classic("mRMRe.Filter",
                           data = mrmr,
                           target_indices = 41,
                           feature_count = 10,
  ...
  TRAINVALID[[3]][[5]][[j]][[1]] = TrainValidWasting[[j]][,factors]
  TRAINVALID[[3]][[5]][[j]][[2]] = TestWasting[[j]][,factors]
}
################################################################################
library(praznik)

  for (j in 1:10){
    jmi = JMI(as.data.frame(TrainValidStunting[[j]][-ncol(TrainValidStunting[[j]])]),
          as.vector(TrainValidStunting[[j]][,ncol(TrainValidStunting[[j]])]),
          k = 10
          )
    factors = c()
    for (k in 1:10){
      factors[k] = jmi$selection[[k]]
    }
    TRAINVALID[[1]][[6]][[j]][[1]] = TrainValidStunting[[j]][,factors]
    TRAINVALID[[1]][[6]][[j]][[2]] = TestStunting[[j]][,factors]
  }
for (j in 1:10){
    jmi = JMI(as.data.frame(TrainValidThinness[[j]][-ncol(TrainValidThinness[[j]])]),
          as.vector(TrainValidThinness[[j]][,ncol(TrainValidThinness[[j]])]),
          k = 10
          )
    factors = c()
    for (k in 1:10){
    ...
    TRAINVALID[[2]][[6]][[j]][[1]] = TrainValidThinness[[j]][,factors]
    TRAINVALID[[2]][[6]][[j]][[2]] = TestThinness[[j]][,factors]
}
for (j in 1:10){
    jmi = JMI(as.data.frame(TrainValidWasting[[j]][-ncol(TrainValidWasting[[j]])]),
          as.vector(TrainValidWasting[[j]][,ncol(TrainValidWasting[[j]])]),
          k = 10
          )
    factors = c()
    for (k in 1:10){
    ...
    TRAINVALID[[3]][[6]][[j]][[1]] = TrainValidWasting[[j]][,factors]
    TRAINVALID[[3]][[6]][[j]][[2]] = TestWasting[[j]][,factors]
}
################################################################################
#ChiSq
...
for (j in 1:10){
  ...
  row.names(factors) = names(stunting)[1:40]
  for (factor in 1:40){
    chisq = chisq.test(table(TrainValidStunting[[j]][,factor],
                               TrainValidStunting[[j]]$Stunting)
                         )
    if (chisq$p.value < 0.05){
      factors[[factor, 1]] = chisq$p.value
    }
  ...
  factors = order(factors$PV)[1:10]
  TRAINVALID[[1]][[7]][[j]][[1]] = TrainValidStunting[[j]][,factors]
  TRAINVALID[[1]][[7]][[j]][[2]] = TestStunting[[j]][,factors]
}
for (j in 1:10){
  factors = data.frame(PV = double())
  for (i in 1:40){
  ...
  row.names(factors) = names(stunting)[1:40]
  for (factor in 1:40){
    chisq = chisq.test(table(TrainValidThinness[[j]][,factor],
                               TrainValidThinness[[j]]$Thinness)
                         )
    if (chisq$p.value < 0.05){
      factors[[factor, 1]] = chisq$p.value
    }
  ...
  factors = order(factors$PV)[1:10]
  TRAINVALID[[2]][[7]][[j]][[1]] = TrainValidThinness[[j]][,factors]
  TRAINVALID[[2]][[7]][[j]][[2]] = TestThinness[[j]][,factors]
}
for (j in 1:10){
  factors = data.frame(PV = double())
  for (i in 1:40){
  ...
  row.names(factors) = names(stunting)[1:40]
  for (factor in 1:40){
    chisq = chisq.test(table(TrainValidWasting[[j]][,factor],
                               TrainValidWasting[[j]]$Wasting)
                         )
    if (chisq$p.value < 0.05){
      factors[[factor, 1]] = chisq$p.value
    }
  ...
  factors = order(factors$PV)[1:10]
  TRAINVALID[[3]][[7]][[j]][[1]] = TrainValidWasting[[j]][,factors]
  TRAINVALID[[3]][[7]][[j]][[2]] = TestWasting[[j]][,factors]
}
```



```{r Classifier Test Set Preparation, warning = FALSE}
#Creating test sets of selected features from original datasets for use in classifier modelling.
TEST = list(Stunting = list(None = list(),
                                MVLoR = list(),
                                UVLoR = list(),
                                IG = list(),
                                MRMR = list(),
...
################################################################################
TEST[[1]][["None"]] = testSetsStunting
TEST[[1]][["MVLoR"]] = testSetsStunting
for (i in 1:10){
    TEST[[1]][["MVLoR"]][[i]] = TEST[[1]][["MVLoR"]][[i]][,c(2,3,5,41)]
}
TEST[[1]][["UVLoR"]] = testSetsStunting
for (i in 1:10){
    TEST[[1]][["UVLoR"]][[i]] = TEST[[1]][["UVLoR"]][[i]][,c(1,4,41)]
}
TEST[[1]][["IG"]] = NA
TEST[[1]][["MRMR"]] = testSetsStunting
for (i in 1:10){
    TEST[[1]][["MRMR"]][[i]] = TEST[[1]][["MRMR"]][[i]][,c(1:4,12,24,26,35,40,41)]
}
TEST[[1]][["JMI"]] = testSetsStunting
for (i in 1:10){
    TEST[[1]][["JMI"]][[i]] = TEST[[1]][["JMI"]][[i]][,c(1:4,8,12,13,41)]
}
TEST[[1]][["ChiSq"]] = NA
################################################################################
TEST[[2]][["None"]] = testSetsThinness
for (i in 1:10){
    TEST[[2]][["None"]][[i]] = TEST[[2]][["None"]][[i]]
}
TEST[[2]][["MVLoR"]] = testSetsThinness
for (i in 1:10){
    TEST[[2]][["MVLoR"]][[i]] = TEST[[2]][["MVLoR"]][[i]][,c(11,17,41)]
}
TEST[[2]][["UVLoR"]] = testSetsThinness
for (i in 1:10){
    TEST[[2]][["UVLoR"]][[i]] = TEST[[2]][["UVLoR"]][[i]][,c(3,8,28,29,41)]
}
TEST[[2]][["IG"]] = testSetsThinness
for (i in 1:10){
    TEST[[2]][["IG"]][[i]] = TEST[[2]][["IG"]][[i]][,c(13,29,5,24,8,38,23,28,41)]
}
TEST[[2]][["MRMR"]] = testSetsThinness
for (i in 1:10){
  TEST[[2]][["MRMR"]][[i]] = TEST[[2]][["MRMR"]][[i]][,c(36,15,3,26,39,35,20,33,41)]
}
TEST[[2]][["JMI"]] = testSetsThinness
for (i in 1:10){
    TEST[[2]][["JMI"]][[i]] = TEST[[2]][["JMI"]][[i]][,c(1,28,40,12,13,29,34,4,5,24,35,8,38,35,21,41)]
}
TEST[[2]][["ChiSq"]] = testSetsThinness
for (i in 1:10){
    TEST[[2]][["ChiSq"]][[i]] = TEST[[2]][["ChiSq"]][[i]][,c(1,3,29,39,8,32,33,41)]
}
################################################################################
TEST[[3]][["None"]] = testSetsWasting
for (i in 1:10){
    TEST[[3]][["None"]][[i]] = TEST[[3]][["None"]][[i]]
}
TEST[[3]][["MVLoR"]] = testSetsWasting
for (i in 1:10){
    TEST[[3]][["MVLoR"]][[i]] = TEST[[3]][["MVLoR"]][[i]][,c(2,17,41)]
}
TEST[[3]][["UVLoR"]] = testSetsWasting
for (i in 1:10){
    TEST[[3]][["UVLoR"]][[i]] = TEST[[3]][["UVLoR"]][[i]][,c(1,16,41)]
}
TEST[[3]][["IG"]] = testSetsWasting
for (i in 1:10){
    TEST[[3]][["IG"]][[i]] = TEST[[3]][["IG"]][[i]][,c(1,41)]
}
TEST[[3]][["MRMR"]] = testSetsWasting
for (i in 1:10){
    TEST[[3]][["MRMR"]][[i]] = TEST[[3]][["MRMR"]][[i]][,c(1,36,10,11,15,26,17,20,41)]
}
TEST[[3]][["JMI"]] = testSetsWasting #None
for (i in 1:10){
    TEST[[3]][["JMI"]][[i]] = TEST[[3]][["JMI"]][[i]][,c(1,2,28,40,11,12,13,29,34,5,24,35,8,38,23,21,41)]
}
TEST[[3]][["ChiSq"]] = testSetsWasting #None
for (i in 1:10){
    TEST[[3]][["ChiSq"]][[i]] = TEST[[3]][["ChiSq"]][[i]][,c(1,16,20,41)]
}
```
...
for (i in 1:3){ #3 response sets (Stunting, Thinness, Wasting)
  #if (i > 1){break}
  for (j in 1:7){ #7 feature selection (FS) sets
    if (length(TRAINVALID[[i]][[j]]) == 1){
      next
    }
    for (k in 1:10){ #10 test sets total
        train = TRAINVALID[[i]][[j]][[k]] #Import & coerce to matrix in order to scale
        train[,ncol(train)] = as.factor(train[,ncol(train)]) #Set response as factor
        
        test = TEST[[i]][[j]][[k]] #Prepare test; 1 test set for 10 train/valid sets (seen below)
        if (length(range(test[,ncol(test)])) != 2){ #Should be both 0s and 1s as response vars
          next
        }else if (range(test[,ncol(test)])[2] != 1){
          next
        }
        test[,ncol(test)] = as.factor(test[,ncol(test)])

        MVLoR = glm(paste0(names(train)[ncol(train)], "~."),
                    data = train,
                    family = "binomial"
                    )
        y_pred = predict(MVLoR, newdata = test[-ncol(test)], type = "response")
        #probs = prediction(y_pred[,2], test[,ncol(test)])
        y_pred = unname(1*(y_pred >= 0.5))
        CM = confusionMatrix(data = as.factor(y_pred),
                             reference = test[,ncol(test)]
                             )
        ...
        Scores_MVLoR[[i]][[j]][[2]] = Scores_MVLoR[[i]][[j]][[2]] + F1
        if(F1 > best$F1){
          #ROC_MLR = performance(probs, "tpr", "fpr")
          #AUC_MLR = performance(probs, "auc")@y.values[[1]]
          best$accuracy = accuracy
          best$RS = i
          best$FS = j
          best$test = k
      ...
      Scores_MVLoR[[i]][[j]][[1]] = Scores_MVLoR[[i]][[j]][[1]]/10
      Scores_MVLoR[[i]][[j]][[2]] = Scores_MVLoR[[i]][[j]][[2]]/10
  }}
#plot(ROC_MLR, main = "XGB ROC Plot")
#abline(0, 1)
```
...
for (i in 1:3){ #3 response sets (Stunting, Thinness, Wasting)
  for (j in 1:7){ #7 feature selection (FS) sets
    ...
    for (k in 1:10){ #10 test sets total
        ...
        y_pred = predict(RF, newdata = as.matrix(test[-ncol(test)]))
        #probs = prediction(y_pred[,2], test[,ncol(test)])
        #y_pred = 1*(y_pred >= 0.5)[,2]
        CM = confusionMatrix(data = y_pred,
                             reference = as.factor(test[,ncol(test)])
                             )
        accuracy = CM$overall[["Accuracy"]]
        F1 = CM$byClass[["F1"]]
        Scores_RF[[i]][[j]][[1]] = Scores_RF[[i]][[j]][[1]] + accuracy
        Scores_RF[[i]][[j]][[2]] = Scores_RF[[i]][[j]][[2]] + F1
        if(F1 > best$F1){
          #ROC_RF = performance(probs, "tpr", "fpr")
          #AUC_RF = performance(probs, "auc")@y.values[[1]]
          best$accuracy = accuracy
          best$RS = i
          best$FS = j
          best$test = k
      ...
      Scores_RF[[i]][[j]][[1]] = Scores_RF[[i]][[j]][[1]]/10
      Scores_RF[[i]][[j]][[2]] = Scores_RF[[i]][[j]][[2]]/10
    }}
#plot(ROC_RF, main = "XGB ROC Plot")
#abline(0, 1)
```
...
for (i in 1:3){ #3 response sets (Stunting, Thinness, Wasting)
  ...
  for (j in 1:7){ #7 feature selection (FS) sets
    ...
    for (k in 1:10){ #10 test sets total
        ...
        y_pred = predict(SVM, newdata = as.matrix(test[-ncol(test)]))
        #probs = prediction(y_pred[,2], test[,ncol(test)])
        CM = confusionMatrix(data = y_pred,
                             reference = as.factor(test[,ncol(test)])
                             )
        ...
        Scores_SVM[[i]][[j]][[2]] = Scores_SVM[[i]][[j]][[2]] + F1
        if(F1 > best$F1){
          #ROC_SVM = performance(probs, "tpr", "fpr")
          #AUC_SVM = performance(probs, "auc")@y.values[[1]]
          best$accuracy = accuracy
          best$RS = i
          best$FS = j
          best$test = k
      ...
      Scores_SVM[[i]][[j]][[1]] = Scores_SVM[[i]][[j]][[1]]/10
      Scores_SVM[[i]][[j]][[2]] = Scores_SVM[[i]][[j]][[2]]/10
  }}
#plot(ROC_SVM, main = "XGB ROC Plot")
#abline(0, 1)
```
...
for (i in 1:3){ #3 response sets (Stunting, Thinness, Wasting)
  for (j in 1:7){ #7 feature selection (FS) sets
    ...
    for (k in 1:10){ #10 test sets total
        ...
        xgbGrid <- expand.grid(nrounds = c(50),#,100),  
                       max_depth = c(5),#, 10, 15, 20),
                       colsample_bytree = c(0.1),#, 0.5, length.out = 5),
                       ## The values below are default values in the sklearn-api. 
                       eta = 0.1,
                       gamma=0,
                       min_child_weight = 1,
        ...
        # Predicting the Test set results
        y_pred = predict(XGB, newdata = as.matrix(test[-ncol(test)]))
        #probs = prediction(y_pred[,2], test[,ncol(test)])
        #y_pred = 1*(probs@predictions[[1]] >= 0.5)
        CM = confusionMatrix(data = as.factor(y_pred),
                             reference = as.factor(test[,ncol(test)])
                             )
        accuracy = CM$overall[["Accuracy"]]
        ...
        Scores_XGB[[i]][[j]][[2]] = Scores_XGB[[i]][[j]][[2]] + F1
        if(F1 > best$F1){
          #ROC_XGB = performance(probs, "tpr", "fpr")
          #AUC_XGB = performance(probs, "auc")@y.values[[1]]
          best$accuracy = accuracy
          best$RS = i
          best$FS = j
          best$test = k
    ...
    Scores_XGB[[i]][[j]][[1]] = Scores_XGB[[i]][[j]][[1]]/10
    Scores_XGB[[i]][[j]][[2]] = Scores_XGB[[i]][[j]][[2]]/10
  }}
#plot(ROC_XGB, main = "XGB ROC Plot")
#abline(0, 1)
```



```{r Classifier Heat Maps}
library("ggplot2") 
library("viridis")
library("forcats")

# XGBSet = read.csv("Scores_XGB.csv")
# Scores_XGB = list(Stunting = list(None = list(Accuracy = 0, F1 = 0),
#                                 MVLoR = list(Accuracy = 0, F1 = 0),
#                                 UVLoR = list(Accuracy = 0, F1 = 0),
#                                 IG = list(Accuracy = 0, F1 = 0),
...
#                                 )
#                 )
# #The below script reads results and rewrites them to the correct format needed.
# index = 2
# for (i in 1:3){
#   for (j in 1:7){
#     for (k in 1:2){
#         Scores_XGB[[i]][[j]][[k]] = XGBSet[[index]]
#         index = index + 1
#     }
#   }
# }
################################################################################
for (score in c("Accuracy", "F1")){
  for (response in c("Stunting", "Thinness", "Wasting")){
    RF = c()
    j = 1
    for (i in c(1,3,2,7,4,5,6)){ #Re-arrange results to the order we want them to appear in the heat map
      RF[j] = round(Scores_RF[[response]][[i]][[score]], 2)*100 #Round to 3 decimal places
      j=j+1
    }
    
    SVM = c()
    j = 1
    for (i in c(1,3,2,7,4,5,6)){
      SVM[j] = round(Scores_SVM[[response]][[i]][[score]], 2)*100 #Round to 3 decimal places
      j=j+1
    }
    ...
    j = 1
    for (i in c(1,3,2,7,4,5,6)){
      XGB[j] = round(Scores_XGB[[response]][[i]][[score]], 2)*100 #Round to 3 decimal places
      j=j+1
    }
    ...
    j = 1
    for (i in c(1,3,2,7,4,5,6)){
      LogReg[j] = round(Scores_MVLoR[[response]][[i]][[score]], 2)*100 #Round to 3 decimal places
      j=j+1
    }
    mapdata = data.frame(Classifier = c(rep("XGB", 7),
                                         rep("RF", 7),
                                         rep("SVM", 7),
                                         rep("MLR", 7)
                                         ),
                         FS = #c(rep(c("All","MLR","ULR","IG","MRMR","JMI","ChiSq"), 4)),
                           c(rep(c("All","ULR","MLR","ChiSq","IG","JMI","MRMR"), 4)),
                         values = c(rep(0, 7),#XGB,
                                    rep(0, 7),#RF,
                                    rep(0, 7),#SVM,
                                    LogReg
                                    )
                         )
    #mapdata$FS = factor(mapdata$FS, levels = mapdata$FS) #Lock in order so ggplot doesn't rearrange alphabetically
    heatmap = ggplot(mapdata, aes(x = fct_inorder(FS),
                                  y = fct_inorder(Classifier), fill = values)) + geom_tile(color = "white", size = 0.5)
    heatmap =  heatmap + geom_text(aes(label = paste0(values, "%")), col = 'black', size = 6) + #Fill percentages into each square on heatmap
      scale_fill_gradient2(low = rgb(163, 29, 42, maxColorValue = 255),
                           mid = rgb(254, 249, 192, maxColorValue = 255),
                           high = rgb(2,105,56, maxColorValue = 255),
                           midpoint = (max(heatmap$data$values) + min(heatmap$data$values))/2,
                           breaks = c(min(heatmap$data$values),
                                      max(heatmap$data$values)), #For "values" color scale on right side of image
                           labels = paste0(c(min(heatmap$data$values),
                                      max(heatmap$data$values)), "%"), #For "values" color scale on right side of image
                           name = score
                           )
    heatmap = heatmap + theme(legend.key.height = unit(1.5, "cm"))#,legend.position = c(1, 0))
    heatmap = heatmap + ggtitle(response) + xlab("Feature Selection") + ylab("Classifier") #Title of heatmap and axis labels
    heatmap = heatmap + theme(text = element_text(size = 18), 
