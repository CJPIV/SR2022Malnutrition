...
#####
```{r ReliefF}
#This one takes ~90 minutes to run. Have fun.
...
stuntingRules = apriori(stunting, parameter = list(support = 0.1, confidence = 0.8))
thinnessRules = apriori(thinness, parameter = list(support = 0.1, confidence = 0.8))
```