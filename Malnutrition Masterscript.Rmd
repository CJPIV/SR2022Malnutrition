...
SURVEY = SURVEY[-1,] #First row is a misread of some kind, full of NAs - drop it
SURVEY = SURVEY[,-c(35, 54, 115, 134)] #Empty columns

#Now the fun part - manually rename anything that the reader did weird
names(SURVEY)[13] = "Class" #Which class of the grade is the child in?
