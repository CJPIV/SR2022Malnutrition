  ...
  for (j in 1:10){
    ...
    for (factor in names(stunting)[1:54]){
      ...
      if (!is.na(regSummary[[index, 2]]) && regSummary[[index, 5]] < 0.05){
        results[[factor, 4]] = results[[factor, 4]] + regSummary[[index, 4]]
      }
    }
  }
}
...
for (i in 1:10){
  for (j in 1:10){
    ...
    for (factor in names(stunting)[1:54]){
      ...
      if (!is.na(regSummary[[index, 2]]) && regSummary[[index, 5]] < 0.05){
        results[[factor, 6]] = results[[factor, 6]] + regSummary[[index, 6]]
      }
    }
  }
}
...
for (i in 1:10){
  for (j in 1:10){
    ...
    for (factor in names(stunting)[1:54]){
      ...
      if (!is.na(regSummary[[index, 2]]) && regSummary[[index, 5]] < 0.05){
        results[[factor, 8]] = results[[factor, 8]] + regSummary[[index, 8]]
      }
    }
  }
}
...
for (i in 1:10){
  for (j in 1:10){
    ...
    for (factor in names(stunting)[1:54]){
      ...
      if (!is.na(regSummary[[index, 2]]) && regSummary[[index, 5]] < 0.05){
        results[[factor, 10]] = results[[factor, 10]] + regSummary[[index, 10]]
      }
    }
  }
}
