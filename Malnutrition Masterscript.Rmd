...
# prevent overfitting. All feature selection methods must be run on SMOTE-
# balanced datasets.
#####
```{r ReliefF}
...
for (i in 1:10){
  ...
  for (j in 1:10){
    relF = relief(Stunting~.,
                as.data.frame(SMOTEStunting[[i]][[j]]$data[[-"class"]]),
                neighboursCount = 5
                )
...
for (i in 1:10){
  ...
  relF = relief(Thinness~.,
                as.data.frame(SMOTEThinness[[i]][[j]]$data[-class]),
                neighboursCount = 5
                )
...
library(FSelectorRcpp)
################################################################################
FS_IG_Stunting = list() #THIS WORKS!
for (i in 1:10){
...
################################################################################
FS_IG_Thinness = list() #THIS WORKS!
for (i in 1:10){
...
for (i in 1:10){
  mrmr = mRMR.data(data = sansTestStunting[[i]])
  FS_MRMR_UB_Stunting = mRMR.classic(data = mrmr)
}
```
...
for (i in 1:10){
  ...
  for (j in 1:10){
    FS_JMI_Stunting[[i]][[j]] = JMI(x = SMOTEStunting[[i]][[j]], 
                                y = SMOTEStunting[[i]][[j]]$data$Stunting
                                )
  }
}
################################################################################
...
for (i in 1:10){
  ...
  for (j in 1:10){
    FS_JMI_Thinness[[i]][[j]] = JMI(x = trainSetsSMOTEThinness[[i]][[j]], 
                                y = trainSetsSMOTEThinness[[i]][[j]]$data$Thinness
                                )
  }
}
```
